  ...
  return (
    <section className="border-t border-border">
      <div className="mx-auto max-w-[1100px] px-5 py-16 sm:px-8 sm:py-20">
        ...
        <Reveal delay={60}>
          <ul className="mt-10 grid grid-cols-3 gap-px overflow-hidden rounded-xl border border-border bg-border sm:grid-cols-3 lg:grid-cols-6">
            {AGENTS.map((agent) => (
              <li
                key={agent.name}
                className="group flex aspect-square flex-col items-center justify-center gap-3 bg-background px-2 text-center"
              >
